...
The headings of the following sections are copied directly from Producing Open Source Software Section 2.2: Getting Started :: Starting from What You Have [Fogel, 19-29][1].  
...
Fogel suggests considering the following when choosing the name for a project [Fogel, 21-22][1]:
...
??The front page must make it unambiguously clear that the project is open source. … State up front, right below the mission statement, that the project is "free software" or "open source software", and give the exact license.?? [Fogel, 23][1]
...
is very hard to shake, once acquired. Conservativism pays off in the long run; it's always better for the software to be more stable than the user expected than less, and pleasant surprises produce the best kind of word-of-mouth.?? [Fogel, 24][1]
...
•	some indication of how development is usually done—is the project a benevolent dictatorship, a democracy, or something else?? [Fogel, 26][1]
...
??Documentation should be available from two places: online (directly from the web site), and in the downloadable distribution of the software?? [Fogel, 28][1]
...
fn1. "Producing Open Source Software":http://producingoss.com/. Fogel, Karl. "http://producingoss.com/":http://producingoss.com/
